...
string POPvScan::getVersion(const char* buff, int &ret){
	size_t start;
	size_t end;
	string s = string(buff, ret);

	const string temp = "+OK "; 
	const string temp2 = " ready.";
...
void POPvScan::filterCallback(const u_char *packet){
